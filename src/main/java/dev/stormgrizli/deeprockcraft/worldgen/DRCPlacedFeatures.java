...
public class DRCPlacedFeatures {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> context) {
       ...
       register(context, NITRA_BLOCK_PLACED_KEY, configuredFeatures.getOrThrow(DRCConfiguredFeatures.DRC_NITRA_BLOCK_KEY),
               DRCOrePlacement.commonOrePlacement(18,
                       HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(320))));
       PlacementUtils.register(context, SPIKE_CRYSTAL, configuredFeatures.getOrThrow(DRCConfiguredFeatures.CRYSTAL_SALT_PITS_FLOOR), CountPlacement.of(UniformInt.of(32, 300)), InSquarePlacement.spread(), PlacementUtils.RANGE_BOTTOM_TO_MAX_TERRAIN_HEIGHT, BiomeFilter.biome());
